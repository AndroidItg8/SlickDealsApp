...
import itg8.com.treatpriceapp.newcategory.adapter.SimpleItemRecyclerViewAdapter;
...
public class CategoryItemListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(DummyContent.ITEMS, getApplicationContext()));
    }
...
//            holder.mLinearLayout.setBackground(getResources().getDrawable(R.drawable.list_selector));
//
//
//
//
